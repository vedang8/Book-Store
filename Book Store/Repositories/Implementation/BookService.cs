    ...
    public class BookService : IBookService
    {
        ...
        public IEnumerable<Book> GetAll()
        {
            var data = (from book in context.Book 
                        join author in context.Author on book.AuthorId equals author.Id.ToString()
                        join publisher in context.Publisher on book.PublisherId equals publisher.Id.ToString()
                        join genre in context.Genre on book.GenreId equals genre.Id.ToString()
                        select new Book
                        {
                            Id = book.Id,
